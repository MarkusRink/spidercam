...
Kurze Erklärungen zu Begriffen in den Plan-Dokumenten.
...
| **Gate / Ducking / Limiter**  | Wie zuvor — pro Stream bzw. Master.                                                      |
...
| Begriff               | Bedeutung                                                           |
| --------------------- | ------------------------------------------------------------------- |
| **PipeWire + C shim** | Audio-Capture in C (`pw_capture.c`); Mic + Sink-Monitor via cgo.    |
